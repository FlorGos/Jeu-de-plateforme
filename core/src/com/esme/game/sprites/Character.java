...
public class Character extends Forme {
    ...
    public void update(float dt){
        ...
        if(this.position.y < (181 + this.hauteurSurPlateforme)){ //pour qu'il soit sur le sol
            this.position.y=181+ this.hauteurSurPlateforme;
            this.fall.y=0;
        }
        ...
        if(!Gdx.input.isKeyPressed(Input.Keys.LEFT)&& !Gdx.input.isKeyPressed(Input.Keys.RIGHT) && this.fall.y==0){
            ...
            this.texture = new Texture(Gdx.files.internal(this.fichierImage));
        }
